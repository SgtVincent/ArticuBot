...
## evaluation with observation mode that does not include goal position information 
# python eval_robogen.py  --low_level_exp_dir "${PROJECT_DIR}/data/low-level-ckpt" \
#   --low_level_ckpt_name low-level.ckpt \
#   --high_level_ckpt_name "${PROJECT_DIR}/data/high_level_200_obj_ckpt.pth"   \
#   --eval_exp_name test_no_goal_gripper_pcd

## evaluation with only pcd observation (no goal or object-gripper displacement)
# python eval_robogen.py  --low_level_exp_dir "${PROJECT_DIR}/data/low-level-ckpt" \
#   --low_level_ckpt_name low-level.ckpt \
#   --high_level_ckpt_name "${PROJECT_DIR}/data/high_level_200_obj_ckpt.pth"   \
#   --eval_exp_name test_act3d_only \
...
python eval_robogen.py  --low_level_exp_dir "${PROJECT_DIR}/data/low-level-ckpt" \
  --low_level_ckpt_name low-level.ckpt \
  --high_level_ckpt_name "${PROJECT_DIR}/data/high_level_200_obj_ckpt.pth"   \
  --eval_exp_name test_no_goal_gripper_pcd_real_camera \
  --real_world_camera 1
